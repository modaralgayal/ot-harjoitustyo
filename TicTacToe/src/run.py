...
def run():
    ...
    grid = menu_main()
    display, grid, height, width, game_board, game_situation, places_on_board, click_ranges = values(grid)

    main(display, grid, height, width, game_board, game_situation, places_on_board, click_ranges)
